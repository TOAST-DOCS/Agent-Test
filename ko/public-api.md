...
파일 최상단에 정의된 공통 setup 블록 (변수 · dict · macro). 아래 두 방식 모두 이 블록에 의존합니다 ([GitHub code view](https://github.com/TOAST-DOCS/Agent-Test/blob/mkdocs-test/ko/public-api.md?plain=1)):
