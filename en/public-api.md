...
|---|---|---|
| compute | Korea (Pangyo) Region<br>Korea (Bundang) Region<br>Korea (Gwangju) Region<br>Japan Region | https://kr1-api-instance-infrastructure.nhncloudservice.com<br>https://kr2-api-instance-infrastructure.nhncloudservice.com<br>https://kr3-api-instance-infrastructure.nhncloudservice.com<br>https://jp1-api-instance-infrastructure.nhncloudservice.com |
...
| `RESIZE` | Instance is changing flavors or migrating to another host<br>The instance is stopped and restarted |
...
| `SHELVED_OFFLOADED` | Instance is shut down |
| `SHUTOFF` | Instance is stopped |
| `SUSPENDED` | Instance has been put into hibernation by an administrator |
| `UNKNOWN` | Instance status is unknown<br>`If the instance enters this status, contact the administrator` |
...
| limit | Query | Integer | - | Number of instances<br>Returns list of up to the specified number of instances |
...
| servers.OS-EXT-STS:power_state | Body | Integer | Power status of the instance<br>- `1`: On<br>- `4`: Off |
...
| server.addresses."Network Name".OS-EXT-IPS-MAC:mac_addr | Body | String | MAC address of port attached to the instance |
| server.addresses."Network Name".version | Body | Integer | IP version of port attached to the instance<br>NHN Cloud supports only IPv4 |
| server.addresses."Network Name".addr | Body | String | IP address of port attached to the instance |
| server.addresses."Network Name".OS-EXT-IPS:type | Body | Enum | IP address type of port<br>One of `fixed` or `floating` |
| server.links | Body | Object | Instance links object |
...
| server.image.links | Body | Object | Instance image links object |
| server.OS-EXT-STS:task_state | Body | String | Instance task state<br>Shows the status of a task operating on an instance |
| server.OS-EXT-STS:vm_state | Body | String | Current status of instance |
| server.OS-SRV-USG:launched_at | Body | Datetime | Time of the last boot of the instance<br>`YYYY-MM-DDThh:mm:ss.ssssss` format |
...
| server.flavor.links | Body | Object | Instance type links object |
...
| server.tenant_id | Body | String | Tenant ID that the instance belongs to |
