...
The sections below contain **intentionally incorrect links** targeting each deterministic rule, and `scripts/e2e-fix-links.sh` judges the correction results by rule.
...
This section was added by PR B. PR A's translation job should not touch this section, and when PR B's translation PR is merged, it should appear only once in en/ja.
