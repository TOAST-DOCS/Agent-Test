...
This document summarizes instance pricing plans and service limits for each plan. Pricing may vary depending on the region and billing method, and you can check detailed pricing in the cost calculator in the console. (Content update test: this sentence should be reflected when the translation is re-executed.)
...
| Recovery method | You can restore directly from the console. |
