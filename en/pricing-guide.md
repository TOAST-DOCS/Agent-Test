...
This document outlines instance pricing plans and the limits provided for each plan. Pricing may vary depending on the region and billing method. For detailed pricing information, you can check the pricing calculator in the console. (Body update test: This sentence should be reflected when the translation is re-run.)
