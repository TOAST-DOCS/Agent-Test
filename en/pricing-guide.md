...
This is a document that summarizes instance pricing plans and the limits provided by each plan. Pricing may vary depending on the region and billing method, and you can check the detailed amounts in the pricing calculator in the console. (Content update test: this sentence should be reflected when the translation is re-run.)
