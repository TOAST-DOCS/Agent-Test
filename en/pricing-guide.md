...
This is a document that summarizes instance pricing plans and per-plan usage limits. Pricing can vary depending on the region and billing method, and you can check the exact amounts in the console's pricing calculator. (Text modification test: This sentence should be reflected when retranslating.)
