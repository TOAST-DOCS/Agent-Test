...
This is a document that outlines instance pricing plans and the limits provided by each plan. Pricing may vary depending on the region and billing method, and you can check the detailed amounts in the pricing calculator in the console. (Content revision test: This sentence should be reflected when retranslating.)
...
| Restore method | You can restore directly from the console. |
