...
This document summarizes instance pricing plans and the service limits provided for each plan. Pricing can vary depending on the region and payment method, and you can check the specific amounts in the pricing calculator in the console. (Body modification test: This sentence should be reflected when re-running the translation.)

<a id="plan-limits"></a>
### Limits by plan { #plan-limits }

| Plan | Max instances | Max block storage | Technical support |
|---|---|---|---|
...
| Recovery method | The backup can be restored directly from the console. |
