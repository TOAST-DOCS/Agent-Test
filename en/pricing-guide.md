...
This document outlines Instance pricing plans and the limits provided for each plan. Pricing may vary depending on the region and payment method, and you can check the specific pricing in the pricing calculator in the console. (Test of document modification: This sentence should be reflected when the translation is re-run.)
...
| Restore method | Snapshots can be restored directly from the console. |
