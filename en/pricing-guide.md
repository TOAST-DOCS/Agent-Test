...
This document outlines Instance pricing plans and the service limits for each plan. Pricing may vary depending on the region and billing method. You can check detailed rates in the console's pricing calculator. (Content update test: This sentence should be reflected when the translation is re-run.)
