...
This document summarizes the instance pricing plans and the limits each plan provides. Prices may vary by region and payment method; see the pricing calculator in the console for details. (Content modification test: This sentence should be reflected when the translation is re-run.)
