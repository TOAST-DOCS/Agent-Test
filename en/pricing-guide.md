...
This document outlines Instance pricing plans and the limits provided for each plan. Prices may vary depending on the region and payment method, and you can check detailed amounts in the pricing calculator in the console. (Body modification test: This sentence should be reflected when the translation is re-executed.)
...
| Restoration method | You can restore directly from the console. |
