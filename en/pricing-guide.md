...
This document summarizes Instance pricing plans and the limits provided per plan. Pricing can vary depending on the region and payment method. You can check the detailed pricing in the console's pricing calculator. (Body modification test: This sentence should be reflected when re-running translation.)
