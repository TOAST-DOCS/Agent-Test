...
This paragraph is a test paragraph added to an existing section. Existing headings should be kept as is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added to test the translation pipeline. It verifies that the new h3 heading is translated and that the same anchor id is assigned to all three languages.
