...
This paragraph is a test paragraph added to an existing section. The existing heading should be maintained as is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added for translation pipeline testing to verify that the newly added h3 heading is translated and the same anchor ID is assigned across all three languages.
