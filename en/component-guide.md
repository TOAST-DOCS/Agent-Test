...
This subsection was added to test the translation pipeline. It verifies that the new h3 is translated and that the same anchor id is assigned in all three languages.
