...
This subsection was added to test the translation pipeline. Verify that new h3 headings are translated and assigned the same anchor ID across three languages.
