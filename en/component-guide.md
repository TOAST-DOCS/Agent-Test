...
This paragraph is a test paragraph added to an existing section. Existing headings must remain as-is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. It verifies that a new h3 heading is translated and the same anchor ID is assigned across all three languages.
