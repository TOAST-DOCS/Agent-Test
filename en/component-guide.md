...
This subsection was added for translation pipeline testing. It verifies that a new h3 heading is translated and assigned the same anchor ID across three languages.
