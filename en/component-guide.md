...
This paragraph is a test paragraph added to the existing section. Existing headings must be maintained as-is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added for translation pipeline testing. It verifies that the new h3 is translated and assigned the same anchor ID across three languages.
