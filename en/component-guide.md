...
This paragraph is a test paragraph added to an existing section. The existing heading must remain as is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added for translation pipeline testing. It verifies that the new h3 heading is translated and the same anchor ID is assigned across three languages.
