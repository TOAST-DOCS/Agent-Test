...
This paragraph is a test paragraph added to an existing section. Existing headings must be kept as-is. (Body text modification test: This sentence should be reflected when the translation is re-run.)

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added for translation pipeline testing. It verifies that new h3 headings are translated and the same anchor ID is assigned in all three languages.
