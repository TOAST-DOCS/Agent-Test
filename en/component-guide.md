...
NAT instance is an instance that allows you to access internet over a specific IP address band in the private network instance. (Body edit test: This sentence should be reflected when the translation is re-run.)
