...
This subsection was added to test the translation pipeline. This confirms that the new h3 heading is translated and assigned the same anchor ID across all three languages.
