...
This paragraph is a test paragraph added to an existing section. Existing headings must be preserved as-is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added for testing the translation pipeline. It verifies that the newly added h3 heading is translated and assigned identical anchor IDs across the three languages.
