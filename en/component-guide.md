...
This is a test paragraph added to an existing section. Existing headings should be preserved as-is.

<a id="test-added-subsection"></a>
### Test Subsection { #test-added-subsection }

This subsection has been added for translation pipeline testing. Verify that the newly added h3 is translated and that the same anchor id is assigned across three languages.
