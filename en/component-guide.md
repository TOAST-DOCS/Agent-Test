...
This paragraph is a test paragraph added to the existing section. The existing heading should remain intact.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added to test the translation pipeline. It verifies that new h3 headings are translated and the same anchor ID is assigned in three languages.
