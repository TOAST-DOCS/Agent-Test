...
This subsection has been added to test the translation pipeline. Verify that the new h3 heading is translated and the same anchor ID is assigned across all three languages.
