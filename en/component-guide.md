...
This paragraph is a test paragraph added to an existing section. Existing headings must be kept as they are.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. Verify that the new h3 heading is translated and receives the same anchor ID in all three languages.
