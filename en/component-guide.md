...
This paragraph is a test paragraph added to an existing section. The existing heading must be kept as it is.

<a id="test-added-subsection"></a>

### Test Subsection for Testing { #test-added-subsection }

This subsection has been added to test the translation pipeline. Verify that the new h3 is translated and the same anchor ID is assigned across three languages.
