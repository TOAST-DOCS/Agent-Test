...
| slow\_query\_log | Enable the `slow_query` log option\. Queries taking more than 10 seconds in accordance with `long_query_time` will be logged to the `slow_query_log`\. | O |
