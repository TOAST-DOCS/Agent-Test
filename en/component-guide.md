...
This subsection has been added for translation pipeline testing. This verifies that the new h3 heading is translated and the same anchor ID is assigned in three languages.
