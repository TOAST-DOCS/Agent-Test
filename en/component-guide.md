...
This paragraph is an additional test paragraph added to an existing section. The existing heading must be maintained as-is.

<a id="test-added-subsection"></a>

### Test sub-section { #test-added-subsection }

This sub-section has been added for testing the translation pipeline. It verifies that new h3 headings are translated and that the same anchor ID is assigned across all three languages.
