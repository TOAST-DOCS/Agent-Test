...
NAT instance is an instance that allows you to access internet over a specific IP address band in the private network instance. (Text update test: This sentence should be reflected when translation is re-run.)
