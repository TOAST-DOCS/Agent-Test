...
This subsection was added to test the translation pipeline. It verifies that the new h3 is translated and assigned the same anchor ID across three languages.
