...
This paragraph is a test paragraph added to an existing section. The existing heading must be kept as-is.

<a id="test-added-subsection"></a>

### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. We verify that new h3 headings are translated and that the same anchor id is assigned across three languages.
