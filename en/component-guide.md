...
This paragraph is a test paragraph added to the existing section. Existing headings must be retained as-is.

<a id="test-added-subsection"></a>
### Test Subsection for Translation { #test-added-subsection }

This subsection has been added to test the translation pipeline. We verify that the new h3 is translated and that the same anchor id is assigned across three languages.
