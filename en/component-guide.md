...
This is a test paragraph added to an existing section. The existing headings must be retained as-is.

<a id="test-added-subsection"></a>

### Test subsection { #test-added-subsection }

This subsection was added for translation pipeline testing. It verifies that the new h3 is translated and the same anchor ID is assigned in all three languages.
