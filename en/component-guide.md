...
This subsection was added to test the translation pipeline. We verify that the new h3 heading is translated and that the same anchor ID is assigned across three languages.
