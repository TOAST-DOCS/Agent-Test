...
This paragraph is a test paragraph added to an existing section. The existing headings must be retained as they are.

<a id="test-added-subsection"></a>

### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. We verify that the new h3 is translated and that the same anchor ID is assigned across all three languages.
