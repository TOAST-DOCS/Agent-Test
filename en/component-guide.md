...
This paragraph is a test paragraph added to an existing section. Existing headings should be maintained as they are.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added for translation pipeline testing. It verifies that new h3 headings are translated and assigned the same anchor IDs across three languages.
