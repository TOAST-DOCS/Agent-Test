...
This paragraph is a test paragraph added to the existing section. The existing headings must be kept as they are.

<a id="test-added-subsection"></a>
### Test sub-section { #test-added-subsection }

This sub-section has been added to test the translation pipeline. We verify that the new h3 is translated and the same anchor id is assigned across all three languages.
