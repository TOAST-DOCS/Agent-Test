...
This paragraph is a test paragraph added to the existing section. The existing heading should remain as is.

<a id="test-added-subsection"></a>
### Test Subsection { #test-added-subsection }

This subsection has been added for translation pipeline testing. It verifies that new h3 headings are translated and that the same anchor ID is assigned across all three languages.
