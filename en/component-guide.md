...
This subsection was added to test the translation pipeline. It verifies that new h3 headings are translated and the same anchor ID is assigned across three languages.
