...
This subsection was added for translation pipeline testing. Verify that a new h3 heading is translated and the same anchor ID is assigned in three languages.
