...
This paragraph is a test paragraph added to an existing section. The existing heading must remain unchanged.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added for testing the translation pipeline. It verifies that a new h3 heading is translated and that the same anchor ID is assigned across all three languages.
