...
This subsection was added for translation pipeline testing. It verifies that new h3 headings are translated and the same anchor ID is assigned across three languages.
