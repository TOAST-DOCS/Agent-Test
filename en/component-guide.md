...
This subsection has been added for translation pipeline testing. It confirms that the new h3 is translated and the same anchor id is assigned in all three languages.
