...
This paragraph is a test paragraph added to an existing section. Existing headings should remain unchanged.

<a id="test-added-subsection"></a>

### Test subsection { #test-added-subsection }

This subsection was added to test the translation pipeline. This verifies that the new h3 heading is translated and the same anchor ID is assigned across the three languages.
