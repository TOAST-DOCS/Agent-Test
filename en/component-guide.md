...
This paragraph is a test paragraph added to an existing section. Existing headings should be preserved as-is.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added for translation pipeline testing. Verify that the new h3 heading is translated and assigned the same anchor ID in all three languages.
