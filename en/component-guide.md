...
This is a test paragraph added to the existing section. Existing headings must be kept as they are.

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. It verifies that the new h3 is translated and assigned the same anchor ID in all three languages.
