...
This paragraph is a test paragraph added to the existing section. The existing heading should remain unchanged. (Body modification test: This sentence should be reflected when the translation is re-executed.)

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. It verifies that new h3 headings are translated and that the same anchor ID is assigned across all three languages.
