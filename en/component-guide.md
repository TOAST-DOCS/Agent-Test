...
NAT instance is an instance that allows you to access internet over a specific IP address band in the private network instance. (Body text modification test: This sentence should be reflected when retranslating.)
