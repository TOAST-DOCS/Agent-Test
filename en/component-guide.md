...
This paragraph is a test paragraph added to an existing section. The existing heading must be maintained as-is.

<a id="test-added-subsection"></a>

### Test Sub-section { #test-added-subsection }

This sub-section has been added to test the translation pipeline. We verify that the new h3 is translated and that the same anchor id is assigned across all three languages.
