...
This subsection was added to test the translation pipeline. It verifies that the new h3 is translated and the same anchor ID is assigned in three languages.
