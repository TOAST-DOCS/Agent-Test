...
This paragraph is a test paragraph added to the existing section. Existing headings must be kept as-is. (Body content update test: This sentence should be reflected when the translation is re-executed.)

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection has been added to test the translation pipeline. It verifies that the new h3 is translated and the same anchor ID is assigned across all three languages.
