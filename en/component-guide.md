...
This paragraph is a test paragraph added to an existing section. Existing headings must remain as-is. (Body edit test: This sentence should be reflected when re-running the translation.)

<a id="test-added-subsection"></a>
### Test subsection { #test-added-subsection }

This subsection was added to test the translation pipeline. Verify that the new h3 is translated and the same anchor ID is assigned across all three languages.
