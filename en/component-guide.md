...
This subsection has been added for translation pipeline testing. We verify that the new h3 is translated and the same anchor id is assigned across all three languages.
