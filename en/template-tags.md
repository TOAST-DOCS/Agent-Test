...
In a shared environment, you can configure this directly in the console. This paragraph is attached directly below the opening tag, so it becomes a single unit with the tag in incremental translation. Settings take effect immediately upon saving.
{% endif %}
