...
The four sections below are the four patterns of that misalignment. (before/after comparison run 20260922-013952) The expected verdict for each section is deterministically checked by `scripts/check_table_parse.py`.
