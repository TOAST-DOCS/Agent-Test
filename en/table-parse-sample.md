...
The four sections below are the four patterns of that divergence. (before/after comparison run 20260922-013952) Each section's expected verdict is checked deterministically by `scripts/check_table_parse.py`.
