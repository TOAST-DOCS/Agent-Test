...
The four sections below are the four patterns of that mismatch. (md_lines before/after comparison 20260922-031407) Each section's expected judgment is deterministically checked by `scripts/check_table_parse.py`.
