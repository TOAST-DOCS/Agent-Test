...
| Mid-insertion test | This is a new intermediate row. It should be translated. | This is a new intermediate row. It should be translated. | This is a new intermediate row. It should be translated. | This is a new intermediate row. It should be translated. |
