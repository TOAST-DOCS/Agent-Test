...
- **Create an instance**: Create a virtual server by selecting an image and a flavor. (list modification test)
...
### Limits and details provided by plan { #feature-by-plan }
