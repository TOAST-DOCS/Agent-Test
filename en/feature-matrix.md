...
This subsection was added to test the translation pipeline. It verifies that the new h3 heading is translated and the same anchor ID is assigned across three languages.
