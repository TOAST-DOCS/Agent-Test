...
- **Create an Instance**: Creates a virtual server by selecting an image and type. (List edit test)
- **Instance Template**: Saves frequently used configurations as a template for reuse.
