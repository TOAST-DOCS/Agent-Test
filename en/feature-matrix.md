...
- **Create an Instance**: Create a virtual server by choosing an image and instance type. (List modification test)
- **Instance Template**: Save frequently used settings as templates and reuse them.
