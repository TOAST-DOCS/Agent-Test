...
- **Create Instances**: Creates a virtual server by selecting an image and a flavor. (List modification test)
...
### Feature availability and details by plan { #feature-by-plan }
