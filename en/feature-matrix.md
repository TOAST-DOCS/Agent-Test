...
- **Create an instance**: You can select an image and type to create a virtual server. (list modification test)
- **Instance template**: You can save frequently used settings as a template and reuse them.
- **Scheduling**: You can start or stop an instance at a specified time.
- **Monitoring**: You can check CPU, memory, and disk usage on the dashboard.
