...
- **Instance Template**: Save frequently used settings as a template and reuse them. (List modification test)
- **Scheduling**: Start or stop instances at a specified time. (List modification test)
- **Monitoring**: View CPU, memory, and disk usage on the dashboard. (List modification test)
