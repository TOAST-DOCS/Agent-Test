...
- **Create an Instance**: Creates a virtual server by selecting an image and instance type. (list modification test)
- **Instance Template**: Saves frequently used settings as templates for reuse.
- **Scheduling**: Starts or stops an instance at a specified time.
- **Monitoring**: Displays CPU, memory, and disk usage on the dashboard.
