...
- **Create an Instance**: Select an image and instance type to create a virtual server. (List modification test)
- **Instance Template**: Save frequently used settings as templates to reuse them.
