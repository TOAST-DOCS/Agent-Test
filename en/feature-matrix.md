...
| Midpoint insertion test | This is a new middle row that should be translated. | This is a new middle row that should be translated. | This is a new middle row that should be translated. | This is a new middle row that should be translated. |
