...
| Middle insertion test | New middle row that must be translated. | New middle row that must be translated. | New middle row that must be translated. | New middle row that must be translated. |
