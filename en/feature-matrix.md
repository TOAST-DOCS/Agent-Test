...
- **Create an Instance**: Creates a virtual server by selecting an image and type. (list modification test)
- **Instance Template**: Saves frequently used settings as templates for reuse.
- **Scheduling**: Starts or stops instances at specified times.
