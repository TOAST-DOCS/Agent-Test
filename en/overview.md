...
This section was newly added for testing the translation pipeline. This confirms that new sections are translated and assigned the same anchor ID in ko/en/ja.
