...
This section was newly added for translation pipeline testing. It verifies whether new sections are translated and the same anchor ID is assigned across ko/en/ja.
