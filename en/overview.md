...
This section has been newly added to test the translation pipeline. It verifies that the new section is translated and assigned the same anchor ID across ko, en, and ja.
