...
This section is newly added for testing the translation pipeline. Verify that the new section is translated and the same anchor ID is assigned across ko/en/ja.
