...
This section was newly added to test the translation pipeline. We verify that the new section is translated and that the same anchor id is assigned across ko/en/ja.
