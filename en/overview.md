...
This section has been newly added for translation pipeline testing. We verify that the new section is translated and the same anchor ID is assigned in ko/en/ja.
