...
## Test Section Added { #test-added-section }

This section has been newly added to test the translation pipeline. We confirm that the new section is translated and that the same anchor id is assigned in ko/en/ja.
