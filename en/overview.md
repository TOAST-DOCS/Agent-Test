...
This section has been newly added to test the translation pipeline. Verify that the new section is translated and the same anchor id is assigned to ko/en/ja.
