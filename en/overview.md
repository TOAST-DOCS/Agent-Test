...
This section has been newly added to test the translation pipeline. We confirm that new sections are translated and assigned the same anchor id in ko/en/ja.
