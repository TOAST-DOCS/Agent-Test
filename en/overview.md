...
<!-- pre-align:aligned sig=3859e5288204 -->
...
The tables below are e2e fixtures. These are for selection guard validation (20260915-103840).
...
| 3 | Body size limit | client_max_body_size 1m; |
