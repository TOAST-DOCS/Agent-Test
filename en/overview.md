...
This section has been newly added to test the translation pipeline. It verifies that the new section is translated and the same anchor ID is assigned to all language versions (en/en/ja).
