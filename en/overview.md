...
Instances created before the November 26, 2024 deployment require GRUB configuration to manipulate the bootloader.
...
Apply the modified configuration. The command to apply the GRUB configuration may differ depending on the OS.
...
This section was added by PR B to validate concurrent PR scenarios. PR A's translation must not delete the translation of this section.
