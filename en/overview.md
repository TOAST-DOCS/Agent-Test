...
This section was newly added for translation pipeline testing. It verifies that the new section is translated and that the same anchor ID is assigned across ko/en/ja.
