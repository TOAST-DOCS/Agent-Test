...
This is a newly added section to test the translation pipeline. It verifies that the newly added section is translated and assigned the same anchor ID across ko/en/ja.
