...
## Additional Testing Section { #test-added-section }

This section has been newly added for testing the translation pipeline. It verifies that the new section is translated and the same anchor ID is assigned in ko, en, and ja versions.
