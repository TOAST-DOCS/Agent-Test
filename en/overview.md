...
This is a newly added section for translation pipeline testing. We verify that the new section is translated and the same anchor ID is assigned across ko/en/ja.
