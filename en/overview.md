...
This section has been newly added to test the translation pipeline. We verify that the new section is translated and that identical anchor IDs are assigned across ko/en/ja.
