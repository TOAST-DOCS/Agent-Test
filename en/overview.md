...
This section is newly added for translation pipeline testing. We verify that the new section is translated and that the same anchor ID is assigned to ko/en/ja.
