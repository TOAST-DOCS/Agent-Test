...
This is a newly added section for testing the translation pipeline. It verifies that the new section is translated and that the same anchor ID is assigned across ko, en, and ja versions.
