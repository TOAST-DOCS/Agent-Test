...
This is a newly added section for testing the translation pipeline. Verify that the new section is translated and the same anchor ID is assigned in ko/en/ja.
