...
This section was newly added to test the translation pipeline. It verifies that the new section is translated and the same anchor ID is assigned across ko/en/ja.
