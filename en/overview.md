...
| x9c | A type added for concurrent PR testing. It does not exist in actual services. |
...
This section is added by PR B for concurrent PR scenario validation. PR A's translation should not erase the translation of this section.
