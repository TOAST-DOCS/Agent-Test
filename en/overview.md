...
This is a new section added for translation pipeline testing.

This verifies that the new section is translated and that the same anchor ID is assigned to ko/en/ja.
