...
This section was newly added to test the translation pipeline. It verifies that new sections are translated and that the same anchor ID is assigned across ko/en/ja.
