...
<!-- pre-align:aligned sig=55b274b1858c -->
...
This section is a temporary marker inserted by scripts/e2e-webhook.sh.
After verifying that the webhook routes this PR to the ko-review / translate job,
the marker is cleaned up by the scheduled restore-alpha-origin run.

<a id="webhook-e2e-20260819-095207"></a>
## webhook e2e marker (20260819-095207) { #webhook-e2e-20260819-095207 }
