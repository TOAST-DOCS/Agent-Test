...
An instance is a virtual server composed of virtual CPUs, memory, and root block storage. You can install your services and applications on this server and use it in combination with the various services provided by NHN Cloud. (Body edit test: This sentence should be reflected when re-running translation.)
...
This section was newly added to test the translation pipeline. We verify that a new section is translated and the same anchor ID is assigned across ko/en/ja.
