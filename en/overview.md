...
This section has been newly added for testing the translation pipeline. We verify that new sections are translated and that the same anchor id is assigned across ko/en/ja.
