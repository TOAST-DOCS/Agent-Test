...
For instances created before November 26, 2024 deployment, GRUB configuration is required to manipulate the bootloader.
...
Apply the changed configuration. The GRUB configuration command may vary depending on the OS.
...
## Add concurrent PR test section { #concurrent-b-added }

This section is a section added by PR B for validating concurrent PR scenarios. The translation in PR A must not delete the translation of this section.
