...
This section has been newly added to test the translation pipeline. It verifies that newly added sections are translated and assigned the same anchor ID across ko/en/ja.
