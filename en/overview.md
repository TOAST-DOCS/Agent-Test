...
This section has been newly added to test the translation pipeline. We verify that the new section is translated and receives the same anchor ID in ko, en, and ja.
