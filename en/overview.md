...
This is a newly added section for testing the translation pipeline. This verifies that the new section is translated and the same anchor ID is assigned across ko/en/ja.
