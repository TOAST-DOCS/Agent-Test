...
This section was added to test the translation pipeline. It verifies that the new section is translated and identical anchor IDs are assigned across ko/en/ja.
