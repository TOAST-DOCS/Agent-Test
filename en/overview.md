...
This section is a newly added section for testing the translation pipeline. We verify that the new section is translated and the same anchor id is assigned to ko/en/ja.
