...
This section is newly added to test the translation pipeline. It verifies that new sections are translated and assigned the same anchor ID across the ko, en, and ja versions.
