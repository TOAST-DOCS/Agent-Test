...
| x9c | This is a type added for concurrent PR testing and does not exist in the actual service. |
...
This section was added by PR B to validate concurrent PR scenarios. The translation of PR A must not delete the translation of this section.
