...
This section has been newly added for testing the translation pipeline. Verify that the new section is translated and that the same anchor ID is assigned in ko/en/ja.
