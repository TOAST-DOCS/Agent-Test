...
This is a newly added section to test the translation pipeline. This verifies that new sections are translated and that the same anchor ID is assigned across ko/en/ja.
