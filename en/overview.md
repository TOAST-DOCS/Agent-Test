...
This section is newly added for testing the translation pipeline. We verify that new sections are translated and assigned the same anchor ID in ko/en/ja.
