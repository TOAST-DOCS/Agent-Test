...
This section has been newly added to test the translation pipeline. It verifies that newly added sections are translated and are assigned the same anchor id across ko/en/ja.
