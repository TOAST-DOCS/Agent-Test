...
This is a newly added section for testing the translation pipeline. We verify that the new section is translated and the same anchor id is assigned in ko/en/ja.
