...
This section is newly added to test the translation pipeline. We verify that new sections are translated and that the same anchor ID is assigned across ko/en/ja.
