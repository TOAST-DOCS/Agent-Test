...
This section was newly added to test the translation pipeline. This verifies that the new section is translated and that the same anchor ID is assigned in ko, en, and ja.
