...
| Waiting time | Waiting time in seconds between retry attempts | 5 |
...
This section has been added to validate table translation. All table headers and cell text below must be translated.

| Item | Description | Default |
|---|---|---|
| Maximum node count | Maximum number of nodes that can be created in a single node pool | 10 |
| Auto Scaling | Automatically adjusts the number of nodes based on load | Disabled |
| Health check interval | Interval at which node status is checked | 5 minutes |
