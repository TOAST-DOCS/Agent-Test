...
This section was added to verify table translation. All table headers and cell text below should be translated.

| Item | Description | Default Value |
|---|---|---|
| Maximum number of nodes | Maximum number of nodes that can be created in a single node pool | 10 |
| Auto scaling | Automatic node scaling based on load | Disabled |
