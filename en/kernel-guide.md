...
| Wait time | Time to wait between retries (seconds) | 5 |
...
This section has been newly added for table translation verification. All header text and cell text in the table below must be translated.

| Item | Description | Default Value |
|---|---|---|
| Maximum number of nodes | Maximum number of nodes that can be created in a single node pool | 10 |
| Auto Scaling | Automatically adjusts the number of nodes based on load | Not Enabled |
| Check interval | Interval for checking node status | 5 minutes |
