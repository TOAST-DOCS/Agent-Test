...
This section has been newly added to validate table translation. Both the headers and cell text in the table below must be translated.
...
| Health check interval | The interval at which node status is checked. | 5 minutes |
