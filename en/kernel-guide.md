...
This section was added for table translation validation. All header and cell text in the table below must be translated.

| Item | Description | Default |
|---|---|---|
| Maximum number of nodes | The maximum number of nodes that can be created in a single node pool. | 10 |
| Auto scaling | Automatically adjust the number of nodes based on load. | Not enabled |
