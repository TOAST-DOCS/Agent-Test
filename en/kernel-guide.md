...
|---|---|---|
| Number of retries | Number of times to retry a failed request | 3 |
...
This section was added to validate table translation. All headers and cell text in the table below must be translated.

| Item | Description | Default |
|---|---|---|
| Maximum number of nodes | The maximum number of nodes that can be created in a single node pool. | 10 |
| Autoscaling | Automatically adjusts the number of nodes based on load. | Disabled |
| Health check interval | The interval for checking node status. | 5 minutes |
