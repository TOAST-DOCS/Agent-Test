...
| Wait time | Wait time between retries (in seconds) | 5 |
...
This section has been added to validate table translations. All table headers and cell content below must be translated.
