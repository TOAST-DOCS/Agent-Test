...
This section has been newly added to validate table translation. The headers and cell text in the table below must all be translated.

| Item | Description | Default Value |
|---|---|---|
| Maximum Nodes | The maximum number of nodes that can be created in a single node pool. | 10 |
| Auto Scaling | Automatically adjust the number of nodes based on load. | Not Set (Use Default) |
