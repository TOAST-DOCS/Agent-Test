...
| Wait time | Time (in seconds) to wait between retries | 5 |
...
## New Table Section for Testing { #test-added-table }

This section has been newly added to validate table translation. The table headers and cell content below must all be translated.

| Item | Description | Default Value |
|---|---|---|
| Maximum Number of Nodes | The maximum number of nodes that can be created in one node pool. | 10 |
| Auto Scaling | Automatically adjusts the number of nodes based on the load. | Disabled |
| Check Period | The period for checking node status. | 5 minutes |
