...
This document is a fixture to verify that Jinja conditional branching and variable substitution in mkdocs-macros are maintained consistently across three languages: Korean, English, and Japanese. Tags are control statements and are not translated; only the body text differs by language. (Body modification test: This sentence should be reflected when the translation is re-executed.)
