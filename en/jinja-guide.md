...
This document is a fixture for verifying that Jinja conditional branching and variable substitution in mkdocs-macros are maintained identically across three languages: Korean, English, and Japanese. Tags are control syntax and are not translated; only the body text differs by language. (Body modification test: This sentence should be reflected when the translation is re-executed.)
