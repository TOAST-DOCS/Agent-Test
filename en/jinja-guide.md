...
This document is a fixture for verifying that Jinja conditional branching and variable substitution in mkdocs-macros remain identical across three languages: ko, en, and ja. Tags are control syntax and are not translated; only the body text differs by language. (Body content test: This sentence should be reflected when the translation is re-run.)
