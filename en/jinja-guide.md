...
This document is a fixture for validating that Jinja conditional branching and variable substitution in mkdocs-macros remain identical across three languages (en/en/ja). Tags are control syntax and are not translated; only the body text differs by language. (Body text modification test: This sentence should be reflected when translation is re-run.)
