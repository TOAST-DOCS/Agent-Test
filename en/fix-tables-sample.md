...
The same section in en/ja does not have the following table. Since the number of tables in the section differs from ko, the maintenance run must rebuild this section body based on ko.
