...
The following table does not exist in the en/ja versions of the same section. Since the number of tables in the section differs from the ko version, the maintenance run must regenerate the body of this section based on the ko version.
