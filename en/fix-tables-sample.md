...
The same section in en/ja does not have the table below. Since the number of tables in the section differs from ko, the maintenance run must regenerate the body of this section based on ko.
