...
* インスタンスあたり 1 つのシリアルコンソール接続のみ可能です。複数接続を試みた場合、正常に接続できない場合があります。
* ユーザーがアップロードしたイメージとプライベートイメージから作成されたインスタンスは、シリアルコンソール接続を保証しません。
* シリアルコンソール接続は最大 10 分間アクセス可能です。
* Windows インスタンスはシリアルコンソール機能をサポートしません。
* 2026 年 1 月 27 日のデプロイ前に作成されたインスタンスは、**[インスタンス停止]** の後に **[インスタンス起動]** が必要です。**[インスタンス再起動]** 機能では適用されません。

> [注意]
> シリアルコンソール経由でインスタンスにアクセスしてブート方法を変更すると、ブートが失敗する可能性があり、その結果についての責任はユーザーにあります。
