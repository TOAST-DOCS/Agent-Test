...
* インスタンスあたり1つのシリアルコンソール接続のみ可能であり、複数接続の試行時に正常に接続できない場合があります。
...
* 2026年1月27日のデプロイ前に作成されたインスタンスは、**[インスタンスの停止]**後に**[インスタンスの開始]**が必要です。**[インスタンスの再起動]**機能では適用されません。

> [注意]
> シリアルコンソールでインスタンスに接続してブート方法を変更する際、ブートに失敗する可能性があり、その結果の責任はユーザーにあります。
