...
* インスタンスごとに 1 つのシリアルコンソール接続のみ可能であり、複数接続を試みた場合、正常に接続できない可能性があります。
* 個人でアップロードしたイメージで作成したインスタンスと個人イメージで作成したインスタンスは、シリアルコンソールアクセスを保証しません。
* シリアルコンソール接続は最大 10 分間アクセス可能です。
* Windows インスタンスはシリアルコンソール機能をサポートしていません。
* 2026 年 1 月 27 日の配布より前に作成したインスタンスは、**[インスタンスの停止]** の後に **[インスタンスの開始]** が必要です。**[インスタンスの再起動]** 機能では適用されません。
