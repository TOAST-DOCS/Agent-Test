...
このサブセクションは、翻訳パイプラインのテストのために追加されました。新規の h3 が翻訳されて、3つの言語に同じアンカー ID が付与されるか確認します。
...
- **[インスタンス作成]**: イメージとタイプを選択し、仮想サーバーを作成します。(リスト修正テスト)
- **[インスタンステンプレート]**: よく使用される構成をテンプレートとして保存し、再利用します。
