...
| 機能コード | 機能名 | Bundang | Pyeongchon | 日本(修正) |
|---|---|---|---|---|
| INST-CREATE | インスタンス作成 | 提供 | 提供 | 提供 |
| 中間挿入テスト | 新しい中間行です。翻訳される必要があります。 | 新しい中間行です。翻訳される必要があります。 | 新しい中間行です。翻訳される必要があります。 | 新しい中間行です。翻訳される必要があります。 |
| INST-TPL | インスタンステンプレート | 提供 | 提供 | 未提供 |
| INST-MON | インスタンス モニタリング | 提供 | 提供 | 提供 |
