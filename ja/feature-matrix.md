...
このサブセクションは翻訳パイプラインのテストのために追加されました。新しい h3 が翻訳され、3 つの言語で同じ anchor id が割り当てられることを確認します。
...
- **インスタンス作成**: イメージとタイプを選択して仮想サーバーを作成します。(リスト編集テスト)
- **インスタンステンプレート**: よく使われる設定をテンプレートとして保存して再利用します。
