...
### セキュリティグループの TCP ポート 3389 (RDP) を許可します。 { #allow-security-group-tcp-port-3389-rdp }
...
| innodb\_file\_per\_table | テーブルが削除されたりTRUNCATEされる時、テーブルスペースがOSにすぐに返却されます。 | 部分サポート |
