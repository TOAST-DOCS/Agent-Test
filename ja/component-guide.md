...
### MariaDB の起動/停止方法 { #how-to-startstop-mariadb }

<!-- TODO: translate body -->

<a id="connect-to-mariadb"></a>
### MariaDB 接続 { #connect-to-mariadb }

<!-- TODO: translate body -->

<a id="initial-setup-after-creating-a-mariadb-instance"></a>
### MariaDB インスタンス作成後の初期設定 { #initial-setup-after-creating-a-mariadb-instance }

<!-- TODO: translate body -->

**MariaDB 起動/停止方法 { #startingstopping-mysql }**
...
**MariaDBインスタンス作成後の初期設定 { #initial-settings-for-mysql-instance }**
...
### Tibero インスタンスの作成 { #create-a-tibero-instance }

<!-- TODO: translate body -->

**Tibero Instance作成 { #description-of-mycnf }**
...
### インスタンスへの接続 { #connect-to-instance }

<!-- TODO: translate body -->

**インスタンス接続 { #description-of-mysql-directory }**
...
### Zookeeper, Kafka broker の起動/停止 { #start-and-stop-zookeeper-kafka-broker }

<!-- TODO: translate body -->

<a id="install-kafka-cluster"></a>
### Kafka Cluster インストール { #install-kafka-cluster }

<!-- TODO: translate body -->

<a id="initial-setup-after-creating-a-kafka-instance"></a>
### Kafka インスタンス作成後の初期設定 { #initial-setup-after-creating-a-kafka-instance }

<!-- TODO: translate body -->

**Zookeeper、Kafka broker起動/停止 { #how-to-startstop-postgresql }**
```
...
**Kafka Clusterインストール { #log-in-to-postgresql }**
...
**Kafkaインスタンス作成後の初期設定 { #create-postgresql-instance-and-perform-initial-setup }**
